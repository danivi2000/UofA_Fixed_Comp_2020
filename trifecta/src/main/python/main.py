...
# Form implementation generated from reading ui file 'trifecta.ui'
#
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.app_name.setText(_translate("MainWindow", "Welcome to Trifecta"))
        self.eeg_box.setText(_translate("MainWindow", "EEG"))
        self.environment_box.setText(_translate("MainWindow", "Environment  Tracking"))
        self.visualize_scr.setText(_translate("MainWindow", "Start Visualization"))
